# Code for cloud developer (udacity nanodegree) project
...
Create a project folder in your local computer and clone the following Git repository - https://github.com/tsawan/cloud-svcs
